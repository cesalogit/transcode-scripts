...
if (($channels == 6)); then
    handbrake_options="$handbrake_options --aencoder copy:ac3 --mixdown 6ch"
elif (($channels == 8)); then
    handbrake_options="$handbrake_options --aencoder copy:ac3 --mixdown 6ch"
elif (($channels > 60)); then
    handbrake_options="$handbrake_options --audio $langeng --aencoder copy:ac3 --mixdown 6ch"
...
else handbrake_options="$handbrake_options --aencoder copy:ac3"
fi
